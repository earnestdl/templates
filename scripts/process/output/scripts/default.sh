...
print-scripts() {
    ...
    echo
    echo "To use a different language, change the 'type' parameter for the stage you want to use it in"
    echo "to one of the supported script types in your pipeline.yml or workflow.yml."
    echo
