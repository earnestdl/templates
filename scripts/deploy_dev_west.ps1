...
Write-Host "##vso[task.setvariable variable=OPENSHIFT_CLUSTER]${APP_DEPLOY_ENV}-west-openshift-cluster.com"
Write-Host "##vso[task.setvariable variable=TEST_PLAIN_TEXT]$(PLAIN_TEXT_TEST)"
Write-Host "##vso[task.setvariable variable=OPENSHIFT_TOKEN;issecret=true]$(OPENSHIFT_TOKEN_DEV_E2)"
